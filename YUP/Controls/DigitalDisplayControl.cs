...
namespace Ca.Magrathean.Yup.Controls
{
    public partial class DigitalDisplayControl : UserControl
    {
        ...
        private void DigitalGauge_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (AutoSize)
            {
                Size newSize = digitSizeF.ToSize();
            ...
            {
                using (SolidBrush lightBrush = new SolidBrush(Color.FromArgb(75, _digitColor)))
                {
    ...
    public class SevenSegmentHelper
    {
        ...
        public SizeF GetStringSize(string text, Font font)
        {
            ...
            for (int i = 0; i < text.Length; i++)
            {
                ...
                {
                    sizef.Width += 24 * _graphics.DpiX * font.SizeInPoints / 72 / 72;
                }
                else if (text[i] == ' ')
                {
                    sizef.Width += 42 * _graphics.DpiX * font.SizeInPoints / 72 / 72;
        ...
        private float DrawDot(Font font, Brush brush, float x, float y)
        {
            ...
            dotPoints[0] = new Point[] {new Point( 2, 60), new Point( 12, 50), new Point(22, 60), new Point( 12, 70)};
            ...
            return x + 24 * _graphics.DpiX * font.SizeInPoints / 72 / 72;
        }
        ...
        private float DrawColon(Font font, Brush brush, float x, float y)
        {
            ...
            colonPoints[0] = new Point[] {new Point( 2, 20), new Point(12, 10), new Point(22, 20), new Point( 12, 30)};
            colonPoints[1] = new Point[] {new Point( 2, 50), new Point(12, 40), new Point(22, 50), new Point( 12, 60)};
